...
function ThemeToggler() {
  ...
  }, [enableDarkMode, handleThemePreferenceChange]);
  ...
  return (
    <label class="theme-toggler__label" htmlFor="theme-toggler">
      <input
        type="checkBox"
        class="theme-toggler"
        id="theme-toggler"
